    ...
    <div class="bg-white rounded-lg shadow flow-editor-panel">
        ...
        <form id="flow-form" class="p-6 space-y-6">
            ...
            <div>
                ...
                <textarea name="description" id="flow-description" rows="5" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Quem você é, tom e limites (instrução interna). Não escreva aqui a fala que o cliente deve receber — isso faz a IA repetir o bloco. Use o Prompt da ação “Resposta com IA” para a tarefa concreta."></textarea>
